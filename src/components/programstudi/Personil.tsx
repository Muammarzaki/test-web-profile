...
export const Personil = ({ data }: ProgramStudi) => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
      {data.content.map((personil, index) => (
        <div
          key={index}
        ...
        >
          ...
          <div className="relative p-6">
            ...
            {/* Content */}
            <div className="mt-4">
              <h3 className="text-2xl font-bold text-gray-900 mb-2">{personil.nama}</h3>
              <p className="text-gray-600 mb-4">NIP. {personil.nip}</p>
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center text-gray-600">
                  ...
                  <span className="text-sm">Website Personal</span>
                </div>
              </div>
